function [ locomotor_trace, distance_moved, delta_distance, TimeStartBio] = biobserve_import( varargin )
...
% all y coordinates in the second collumn. The timeline (s) is in the third
% collumn.
%
%   Inputs:
...
%Export raw_data as a seperate output argument
TimeStartBio = data{1,3}(1);
