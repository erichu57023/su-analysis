...
[TimeStamps_cells, ScNumbers, CellNumbers, Features, Samples, Header] = Nlx2MatSpike('TT3_all.ntt', [1 1 1 1 1], 1, 1, [] ); %clustering file
...
for clust = 1 % write cluster number 
    figure;
