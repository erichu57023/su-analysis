...
filename_biobserve = '20190430_SUBLAT1_1_Jelly_OFF.csv';
filename_eventfile = 'Events.nev';

% other variables
timestamp_interval = 5; %Sec
%arena = [200 -290 160 80];
nr_bins = 3; %Actual the square root of the number of bins
...
cell_nr = 0;
cell_stamps = Tetrode.timestamps(Tetrode.cells==0)';
