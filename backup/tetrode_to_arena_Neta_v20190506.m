...
% addpath('E:\analysis\Events_spikes_v.2.1\Field Trip Neuralynx');
%% File location
ComputerDir='I:\'; %location of NLX files
BioObserveDir='J:\Single unit videos\Compressed';%location of Bioobserve video files
%% Variables
Date='2019-05-03';
...
ChooseFileNumber = [4]; % what files to run %Exposure
...
for FileNumber = ChooseFileNumber+2
    ...
    FileDirNLX(FileNumber).name % display file name
