...
addpath('E:\analysis\Neuralynx Scripts\MatlabImportExport_v6.0.0');

% addpath(genpath('E:\analysis\Neuralynx Scripts\MatlabImportExport_v6.0.0'));
% ComputerDir='C:\Users\netas\Google Drive\Single Unit Data';
% ComputerDir='E:\CheetahData\NG\Data';%% for Neuralynx computer
% ComputerDir='E:\Single Unit Data';%% for external heard drive
...
ChooseTetrodeNumber=[1:8]; % what Tetrodes to run [1 2 3 4 5 6 7 8]%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for FileNumber = ChooseFileNumber+2
    disp(['File number ',num2str(FileNumber),'_',FileDir(FileNumber).name]) % display file name
